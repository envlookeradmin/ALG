---
- dashboard: envases_74_bis_europe_ecn_media
  title: Envases_74_BIS_Europe (ECN Media)
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: an6t6giqk4ACdVnwXrUtwK
  elements:
  - name: ''
    type: text
    title_text: ''
  ...
  - title: CURRENCY
    ...
    width: 5
    height: 4
  - title: ECN - NORTH (Mediapack)
    name: ECN - NORTH (Mediapack)
    model: envases-alg
    explore: rpt_alg
    type: looker_grid
