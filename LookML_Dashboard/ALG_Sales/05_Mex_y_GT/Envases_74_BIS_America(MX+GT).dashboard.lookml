---
- dashboard: envases_74_bis_americamxgt
  title: Envases_74_BIS_America(MX+GT)
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: 5UjpoJcS6fPEHlRi5GKIXX
  elements:
  - name: ''
    type: text
    title_text: ''
  ...
  - title: GUATEMALA
    ...
    width: 24
    height: 6
  - title: TOTAL México y Guatemala
    name: TOTAL México y Guatemala
    model: envases-alg
    explore: rpt_alg
    type: looker_grid
    ...
    filters:
      ...
      rpt_alg.cluster: GUATEMALA,MEXICO
