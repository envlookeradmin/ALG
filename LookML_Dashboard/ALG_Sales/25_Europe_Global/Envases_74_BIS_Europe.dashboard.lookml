---
- dashboard: envases_74_bis_europe
  title: Envases_74_BIS_Europe
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: DdcGhzoopiMX5JkLHzAbU2
  elements:
  - name: ''
    type: text
    title_text: ''
  ...
  - title: Summary Europe
    ...
    filters:
      rpt_alg.category: "-TOTAL MXN,-TOTAL EUR"
      rpt_alg.category2: ECC - CENTRAL (EUR),ECN - NORTH (DKK),ECS - SOUTH (EUR),ECW
