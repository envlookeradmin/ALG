---
- dashboard: preliminaryenvases_74_bis_subcateg_europe
  title: Preliminary-Envases_74_BIS_SubCateg (Europe)
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: xzdnm9SQq9zyI41vosBRHo
  elements:
  - name: ''
    type: text
    title_text: ''
  ...
  - title: ECN - NORTH
    ...
    explore: rpt_alg
    type: looker_grid
    fields: [rpt_alg.category, rpt_alg.vacio_1, rpt_alg.vacio_2, rpt_alg.sort_category_denmark,
  ...
  - title: ECC - CENTRAL
    ...
    explore: rpt_alg
    type: looker_grid
    fields: [rpt_alg.sort_category, rpt_alg.category, rpt_alg.vacio_1, rpt_alg.vacio_2,
      rpt_alg.DAILY_SALES, rpt_alg.TOTAL_QTY_MTD, rpt_alg.VS_T_QTY_MTD_LY, rpt_alg.VS_T_QTY_BUD_MTD,
      rpt_alg.TOTAL_AMOUNT_MTD, rpt_alg.VS_T_AMOUNT_MTD_LY, rpt_alg.VS_TOTAL_BUD_MTD,
      rpt_alg.TOTAL_AMOUNT_MTD_LY, rpt_alg.TOTAL_AMOUNT_BUD_MTD, rpt_alg.TOTAL_QTY_YTD,
      rpt_alg.VS_T_QTY_YTD_LY, rpt_alg.VS_T_QTY_BUD_YTD, rpt_alg.TOTAL_AMOUNT_YTD,
    ...
    pinned_columns:
      ...
      rpt_alg.DAILY_SALES: left
    column_order: [rpt_alg.sort_category, rpt_alg.category, rpt_alg.DAILY_SALES, rpt_alg.vacio_1,
  ...
  - name: TOTAL EUROPE
    ...
    explore: rpt_alg
    type: looker_grid
    fields: [rpt_alg.category, rpt_alg.vacio_1, rpt_alg.vacio_2, rpt_alg.DAILY_SALES,
      rpt_alg.TOTAL_AMOUNT_MTD, rpt_alg.VS_T_AMOUNT_MTD_LY, rpt_alg.VS_TOTAL_BUD_MTD,
      rpt_alg.TOTAL_AMOUNT_MTD_LY, rpt_alg.TOTAL_AMOUNT_BUD_MTD, rpt_alg.TOTAL_AMOUNT_YTD,
      rpt_alg.VS_T_AMOUNT_YTD_LY, rpt_alg.VS_TOTAL_BUD_YTD, rpt_alg.TOTAL_AMOUNT_YTD_LY,
      rpt_alg.TOTAL_AMOUNT_BUD_YTD]
    filters:
      rpt_alg.category: TOTAL MXN,TOTAL EUR
      rpt_alg.cluster: ECW - WEST,ECC - CENTRAL,ECN - NORTH,ECS - SOUTH
    ...
    series_column_widths:
      rpt_alg.category: 120
      rpt_alg.vacio_1: 10
      rpt_alg.TOTAL_AMOUNT_YTD_LY: 111
      rpt_alg.TOTAL_AMOUNT_BUD_YTD: 111
      rpt_alg.vacio_2: 10
      rpt_alg.DAILY_SALES: 70
      rpt_alg.TOTAL_AMOUNT_MTD: 112
      rpt_alg.VS_T_AMOUNT_MTD_LY: 117
      rpt_alg.VS_TOTAL_BUD_MTD: 112
      rpt_alg.TOTAL_AMOUNT_MTD_LY: 112
      rpt_alg.TOTAL_AMOUNT_BUD_MTD: 112
      rpt_alg.TOTAL_AMOUNT_YTD: 110
      rpt_alg.VS_T_AMOUNT_YTD_LY: 118
      rpt_alg.VS_TOTAL_BUD_YTD: 110
    series_cell_visualizations:
      rpt_alg.SALES_DAY:
        is_active: false
    series_text_format:
    ...
    width: 24
    height: 3
  - title: SUMMARY EUROPE
    name: SUMMARY EUROPE
    model: envases-alg
    explore: rpt_alg
    type: looker_grid
    fields: [rpt_alg.sort_category2, rpt_alg.category2, rpt_alg.vacio_1, rpt_alg.vacio_2,
      rpt_alg.DAILY_SALES, rpt_alg.TOTAL_AMOUNT_MTD, rpt_alg.VS_T_AMOUNT_MTD_LY, rpt_alg.VS_TOTAL_BUD_MTD,
      rpt_alg.TOTAL_AMOUNT_YTD, rpt_alg.VS_T_AMOUNT_YTD_LY, rpt_alg.VS_TOTAL_BUD_YTD]
    filters:
      rpt_alg.category: "-TOTAL MXN,-TOTAL EUR"
      rpt_alg.category2: ECN - NORTH (DKK),ECC - CENTRAL (EUR),ECS - SOUTH (EUR),ECW
        - WEST (EUR),SUB Europa (EUR)
    ...
    pinned_columns:
      rpt_alg.sort_category: left
      rpt_alg.category: left
    column_order: [rpt_alg.category2, rpt_alg.DAILY_SALES, rpt_alg.vacio_1, rpt_alg.TOTAL_AMOUNT_MTD,
    ...
    series_labels:
      ...
      rpt_alg.BUD_TOTAL_AMOUNT_YEAR_YEAR: BUD TOTAL AMOUNT
      rpt_alg.TOTAL_AMOUNT_YEAR_ANT_YEAR: TOTAL AMOUNT AÑO ANT
      rpt_alg.TOTAL_QTY_MTD: TOTAL QTY
      rpt_alg.VS_T_QTY_MTD_LY: "% VS TOTAL QTY LY"
      rpt_alg.VS_T_QTY_BUD_MTD: "% VS TOTAL QTY BUD"
      ...
      rpt_alg.TOTAL_AMOUNT_MTD_LY: TOTAL AMOUNT LY
      rpt_alg.TOTAL_AMOUNT_BUD_MTD: TOTAL AMOUNT BUD
      rpt_alg.TOTAL_QTY_YTD: TOTAL QTY
      rpt_alg.VS_T_QTY_YTD_LY: "% VS TOTAL QTY LY"
      rpt_alg.VS_T_QTY_BUD_YTD: "% VS TOTAL QTY BUD"
    ...
    series_column_widths:
      ...
      rpt_alg.vacio_1: 10
      rpt_alg.TOTAL_AMOUNT_MTD: 100
      rpt_alg.VS_T_AMOUNT_MTD_LY: 70
      rpt_alg.VS_TOTAL_BUD_MTD: 70
      rpt_alg.TOTAL_AMOUNT_YTD: 100
      rpt_alg.VS_T_AMOUNT_YTD_LY: 70
      rpt_alg.VS_TOTAL_BUD_YTD: 70
