---
- dashboard: envases_74_bis_category_t
  title: Envases 74 Bis Category T
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: y1xPx8x96cto8sFwGh8Qyl
  elements:
  - name: ''
    type: text
    title_text: ''
  ...
  - title: Dato_dia
    ...
    series_labels:
      rpt_alg_category.FCURR: Tipo moneda
      rpt_alg_category.UKURS: Tipo de cambio
    ...
    defaults_version: 1
    listen:
      Períod: rpt_alg_category.date_filter
    row: 2
    col: 19
    width: 5
    height: 2
  ...
  - title: ECN - NORTH
    ...
    series_labels:
      rpt_alg_category.FCURR: Tipo moneda
      rpt_alg_category.UKURS: Tipo de cambio
      rpt_alg_category.TOTAL_AMOUNT: TOTAL AMOUNT
      rpt_alg_category.TOTAL_QTY: TOTAL QTY
      rpt_alg_category.VS_BUD_QTY_T: "% VS BUD QTY T"
      rpt_alg_category.VS_BUD_T: "% VS BUD MTD"
      rpt_alg_category.EXPORT_AMOUNT_MTD: MTD Amount
      rpt_alg_category.EXPORT_BUD_QTY_MTD: MTD
      rpt_alg_category.TOTAL_QTY_YEAR: TOTAL QTY
      rpt_alg_category._VS_YEAR_ANT_QTY_T_YEAR: "% VS AÑO ANT QTY T"
      rpt_alg_category.VS_BUD_QTY_T_YEAR: "% VS BUD QTY T"
      rpt_alg_category.TOTAL_AMOUNT_YEAR: TOTAL AMOUNT
      rpt_alg_category.VS_YEAR_ANT_VAL_T_YEAR: "% VS AÑO ANT VAL"
      rpt_alg_category.VS_BUD_T_YEAR: "% VS BUD MTD"
      rpt_alg_category.EXPORT_AMOUNT_YTD: MTD AMOUNT Y
      rpt_alg_category.EXPORT_AMOUNT_YTD_YEAR_ANT_YEAR: MTD Y
      rpt_alg_category.category: CATEGORY
      rpt_alg_category._VS_YEAR_ANT_QTY_T: "% VS AÑO ANT QTY T"
      rpt_alg_category.VS_YEAR_ANT_VAL_T: "% VS AÑO ANT VAL"
      rpt_alg_category.BUD_TOTAL_AMOUNT_YEAR: BUD TOTAL AMOUNT
      rpt_alg_category.TOTAL_AMOUNT_YEAR_ANT: TOTAL AMOUNT AÑO ANT
      rpt_alg_category.BUD_TOTAL_AMOUNT_YEAR_YEAR: BUD TOTAL AMOUNT
      rpt_alg_category.TOTAL_AMOUNT_YEAR_ANT_YEAR: TOTAL AMOUNT AÑO ANT
      ...
      rpt_alg_category.SALES_DAY: DAILY SALES
  ...
  - title: ECC - CENTRAL
    ...
    explore: rpt_alg_category
    type: looker_grid
    fields: [rpt_alg_category.sort_category, rpt_alg_category.category, rpt_alg_category.vacio_1, rpt_alg_category.vacio_2,
      rpt_alg_category.DAILY_SALES, rpt_alg_category.TOTAL_QTY_MTD, rpt_alg_category.VS_T_QTY_MTD_LY, rpt_alg_category.VS_T_QTY_BUD_MTD,
      rpt_alg_category.TOTAL_AMOUNT_MTD, rpt_alg_category.VS_T_AMOUNT_MTD_LY, rpt_alg_category.VS_TOTAL_BUD_MTD,
      rpt_alg_category.TOTAL_AMOUNT_MTD_LY, rpt_alg_category.TOTAL_AMOUNT_BUD_MTD, rpt_alg_category.TOTAL_QTY_YTD,
      rpt_alg_category.VS_T_QTY_YTD_LY, rpt_alg_category.VS_T_QTY_BUD_YTD, rpt_alg_category.TOTAL_AMOUNT_YTD,
    ...
    pinned_columns:
      ...
      rpt_alg_category.DAILY_SALES: left
    column_order: [rpt_alg_category.sort_category, rpt_alg_category.category, rpt_alg_category.DAILY_SALES, rpt_alg_category.vacio_1,
  ...
  - name: TOTAL AMERICA
    ...
    fields: [rpt_alg_category.category, rpt_alg_category.vacio_1, rpt_alg_category.vacio_2, rpt_alg_category.DAILY_SALES,
      rpt_alg_category.TOTAL_AMOUNT_MTD, rpt_alg_category.VS_T_AMOUNT_MTD_LY, rpt_alg_category.VS_TOTAL_BUD_MTD,
      rpt_alg_category.TOTAL_AMOUNT_MTD_LY, rpt_alg_category.TOTAL_AMOUNT_BUD_MTD, rpt_alg_category.TOTAL_AMOUNT_YTD,
      rpt_alg_category.VS_T_AMOUNT_YTD_LY, rpt_alg_category.VS_TOTAL_BUD_YTD, rpt_alg_category.TOTAL_AMOUNT_YTD_LY,
      rpt_alg_category.TOTAL_AMOUNT_BUD_YTD]
    filters:
    ...
    series_column_widths:
      ...
      rpt_alg_category.vacio_2: 10
      rpt_alg_category.DAILY_SALES: 70
      rpt_alg_category.TOTAL_AMOUNT_MTD: 112
      rpt_alg_category.VS_T_AMOUNT_MTD_LY: 117
      rpt_alg_category.VS_TOTAL_BUD_MTD: 112
      rpt_alg_category.TOTAL_AMOUNT_MTD_LY: 112
      rpt_alg_category.TOTAL_AMOUNT_BUD_MTD: 112
      rpt_alg_category.TOTAL_AMOUNT_YTD: 110
      rpt_alg_category.VS_T_AMOUNT_YTD_LY: 118
      rpt_alg_category.VS_TOTAL_BUD_YTD: 110
      rpt_alg_category.TOTAL_AMOUNT_YTD_LY: 111
      rpt_alg_category.TOTAL_AMOUNT_BUD_YTD: 111
    series_cell_visualizations:
      rpt_alg_category.SALES_DAY:
        is_active: false
    series_text_format:
  ...
  - name: SUMMARY
    ...
    series_labels:
      ...
      rpt_alg_category.BUD_TOTAL_AMOUNT_YEAR_YEAR: BUD TOTAL AMOUNT
      rpt_alg_category.TOTAL_AMOUNT_YEAR_ANT_YEAR: TOTAL AMOUNT AÑO ANT
      rpt_alg_category.TOTAL_QTY_MTD: TOTAL QTY
      rpt_alg_category.VS_T_QTY_MTD_LY: "% VS TOTAL QTY LY"
      rpt_alg_category.VS_T_QTY_BUD_MTD: "% VS TOTAL QTY BUD"
      ...
      rpt_alg_category.TOTAL_AMOUNT_MTD_LY: TOTAL AMOUNT LY
      rpt_alg_category.TOTAL_AMOUNT_BUD_MTD: TOTAL AMOUNT BUD
      rpt_alg_category.TOTAL_QTY_YTD: TOTAL QTY
      rpt_alg_category.VS_T_QTY_YTD_LY: "% VS TOTAL QTY LY"
      rpt_alg_category.VS_T_QTY_BUD_YTD: "% VS TOTAL QTY BUD"
    ...
    series_column_widths:
      ...
      rpt_alg_category.vacio_1: 10
      rpt_alg_category.TOTAL_AMOUNT_MTD: 100
      rpt_alg_category.VS_T_AMOUNT_MTD_LY: 70
      rpt_alg_category.VS_TOTAL_BUD_MTD: 70
      rpt_alg_category.TOTAL_AMOUNT_YTD: 100
      rpt_alg_category.VS_T_AMOUNT_YTD_LY: 70
      rpt_alg_category.VS_TOTAL_BUD_YTD: 70
